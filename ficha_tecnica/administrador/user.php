...
<head>
    ...
    <?php
    include 'librerias-css.php'; // Asegúrate de que aquí se importe indexDashBoard.css con los cambios anteriores
    ?>
...
<body id="body">
    ...
    <div class="dashboard-wrapper">
        <aside id="sidebar-container">
            ...
            <nav class="menu">
                ...
                <a href="user.php" class="menu-item active"><i class="bi bi-people-fill"></i><span>User</span></a>
        ...
        <div id="content-wrapper">
            ...
            <nav class="navbar dashboard-navbar px-4">
                <div class="container-fluid">
                    <h5 class="m-0 font-weight-bold text-muted d-none d-sm-block">Administración</h5>
            ...
            <main class="content-body px-4">
                <div class="card p-4 shadow-sm border-0 bg-white rounded-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="h4 font-weight-bold m-0" style="color: #0f172a;">Listado de Usuarios</h2>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            // Carga asíncrona de la vista de usuarios
            $('#tablaUsuarios').load('./vista_admin/vista_usuario.php');

            // Listeners de eventos para el CRUD
