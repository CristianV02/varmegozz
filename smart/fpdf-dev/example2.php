...
//  $pdf->AddFont('FontUTF8','','./font/Arimo-Regular.php');
//  $pdf->AddFont('FontUTF8','B','./font/Arimo-Bold.php');
//  $pdf->AddFont('FontUTF8','I','./font/Arimo-Italic.php');
//  $pdf->AddFont('FontUTF8','BI','./font/Arimo-BoldItalic.php');
 ...
 $table->easyCell(iconv("UTF-8", 'KOI8-R', '<b>Вери</b> порро <i>номинати</i> вел ех, <b><i>еум</i></b> те лаореет импедит, <s "font-style:B;font-size:18; font-color:#3399ff">ест но ферри ириуре.</s> Ет вис реяуе хомеро. Перфецто сцрипсерит вис еу, нам ин ассум пробатус. Фиерент импердиет аппеллантур меи но, граеце яуодси пертинациа вел ад, не при лудус оратио тациматес. Хис дебет дефинитионес цу.'), 'colspan:4; font-size:12;');

 $table->printRow();

 $table->easyCell("Hola", 'font-size:6; valign:T');
 $table->easyCell("Yo", 'font-size:6; align:C; valign:M');
 ...
 $table->easyCell("Hola", 'img:Pics/tick.png, w30; align:C; valign:B;font-size:6; font-style:I;');
 ...
 for($i=0; $i<10; $i++)
 {
 $table->easyCell("PRUEBA DE ESCTIRUA bastante extensa, lo cualq uiero hacer para ver si rompe toda la fila enla que se encuentra, creo que aun le falta mas texto " . $i ."-" . $n);
