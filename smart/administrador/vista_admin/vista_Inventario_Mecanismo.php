...
$misInventario = new misInventario();
    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Id Inventario</div>
                            </th>
                            <th>
                        ...
                        <tbody>
                            <?php
                            $res = $misInventario->viewInventarios();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <?php echo $data['id_inve']; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                            <?php echo $data['esta_asignado'] == 0 ?
                                                "No Asignado" : "Asignado"; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionInventarioMecanismo" onclick="agregarformInventarioMecanismo('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoInventarioMecanismo">Crear Registro</button>
                <br />
                <br />
                <br />
                <br />
