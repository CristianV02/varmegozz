    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Sustancia</div>
                            </th>
                            <th>
                                <div class="text-center">Cantidad</div>
                            </th>
                            <th>
                                <div class="text-center">mediciones</div>
                            </th>
                            <th>
                        ...
                        <tbody>
                            <?php
                            $cant = 1;
                            $res = $misCantidad->viewCantidades();
                            foreach ($res as $data) {
                                $sustancia = $misSustancias->viewSustancia($data['cod_sustancias']);
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['cod_sustancias'] . "||" .
                                    $data['valor'] . "||" . 
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary  bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionCantidad" onclick="agregarFormCantidad('<?php echo $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoCantidad">Crear Registro</button>
                </br>
                </br>
                </br>
                </br>
