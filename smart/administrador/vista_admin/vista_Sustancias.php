    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a href="laboratorio.php">
                                    <div class="thumbnail btn-accion">
                                        <div class="caption">
                                            <p class="text-center">Laboratorio</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Cantidad en Inventario</div>
                            </th>
                        ...
                        <tbody>
                            <?php
                            $res = $misSustancias->viewSustancias();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['nombre'] . "||" .
                                    $data['laboratorio'] . "||" .
                                    $data['canti_inventario'] . "||" .
                                    $data['nivel_riesgo'] . "||" .
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <?php echo $data['canti_inventario']; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                            <?php echo $data['nivel_riesgo']; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary  bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionSustancias" onclick="agregarformSustancias('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoSustancias">Crear Registro</button>
                <br />
                <br />
                <br />
                <br />
