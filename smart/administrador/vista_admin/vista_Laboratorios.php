    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Nombre Laboratorio</div>
                            </th>
                            <th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <?php echo $data['nombre_laboratorio']; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary  bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionLaboratorio" onclick="agregarformLaboratorio('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoLaboratorio">Crear Registro</button>
                <br />
                <br />
                <br />
                <br />
