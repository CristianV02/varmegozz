...
<div class="d-flex">
    ...
    <div class="container-fluid d-block">
        <div class="w-100">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $cant = 1;
                            $res = $mis_CantidadMecanismoCliente->viewCantidadesMecanismoClientes();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['cod_reporte'] . "||" .
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionReporteMecanismo" onclick="agregarformReporteMecanismo('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
            ...
            <br />
            <!-- <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalNuevoCantidadMecanismoCliente">Crear Registro</button> -->
            <br />
            <br />
            <br />
            <br />
...
<script>
   $(document).ready(function() {
    $('#example').DataTable({
        "paging": true, // Muestra u oculta la paginación
        "lengthChange": false // Oculta el control para cambiar la cantidad de elementos por página
    });
});
