...
$misMecanismo = new misMecanismos();
    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Tipo del mecanimso</div>
                            </th>
                            <th>
                        ...
                        <tbody>
                            <?php
                            $cant = 1;
                            $res = $misMecanismo->viewMecanismos();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['nombre'] . "||" .
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionMecanismo" onclick="agregarformMecanismo('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoMecanismo">Crear Registro</button>
                <br />
                <br />
                <br />
                <br />
