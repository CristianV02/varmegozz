            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $res = $mis_Tratamiento->viewTratamientos();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['tratamiento'];
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary  bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionTratamiento" onclick="agregarformTratamiento('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoTratamiento">Crear tratamiento</button>
                <br />
                <br />
                <br />
                <br />
