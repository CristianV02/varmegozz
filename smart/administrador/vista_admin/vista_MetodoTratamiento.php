...
require_once '../../modelo/datos-metodo_tratamiento.php';
$mis_MetodoTratamiento = new misMetodoTratamiento();
?>
<div class="d-flex">
    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Método <br> Control </div>
                            </th>
                            <th>
                        ...
                        <tbody>
                            <?php
                            $res = $mis_MetodoTratamiento->viewMetodoTratamientos();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['tratamiento'] . "||" .
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary  bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionMetodoTratamiento" onclick="agregarformMetodoTratamiento('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoMetodoTratamiento">Crear Metodo tratamiento</button>
                <br />
                <br />
                <br />
                <br />
