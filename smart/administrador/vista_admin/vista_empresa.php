    ...
    <div class="container-fluid d-block">
        <div class="w-100">
            ...
            <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a href="tipo-documento.php">
                                    <div class="thumbnail btn-accion">
                                        <div class="caption">
                                            <p class="text-center">Tipo de Documento</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            ...
                            <th>
                                <div class="text-center">Nombre establecimiento</div>
                            </th>
                            <th>
                                <div class="text-center">Dirección establecimiento</div>
                            </th>
                            <th>
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoEmpresa">Crear Registro</button>
                </br>
                </br>
                </br>
                </br>
