...
require_once '../../modelo/datos-nivel-infestacion.php';
            ...
            <div class="content">
                ...
                <div class="table-responsive">
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $res = $mis_Infestacion->viewInfestaciones();
                            foreach ($res as $data) {
                                // Datos
                                $datos = $data['codigo'] . "||" .
                                    $data['nivel'];
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-center">
                                            <button class="btn btn-primary  bi bi-pencil-fill" data-bs-toggle="modal" data-bs-target="#modalEdicionNivelInfestaciones" onclick="agregarformNivelInfestaciones('<?php echo  $datos ?>')"></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
                ...
                <br />
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalNuevoNivelInfestaciones">Crear Registro</button>
                <br />
                <br />
                <br />
                <br />
